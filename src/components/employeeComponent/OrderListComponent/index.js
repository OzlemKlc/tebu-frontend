...
import {getWorkerOrders} from "../../../api/order/index"
...
function OrderList() {
  ...
  const getOrdersResponse = () => {
    getWorkerOrders(10, pageIndex, setOrdersResponse);
                        ...
                        <tbody>
                            ...
                            allOrders.map(e => {
                                return (
                                    ...
                                    <td>
                                        <button value={e} onClick={() => {detailsPageButtonFunction(e)}} type="button" class="btn btn-link btn-sm btn-rounded">Details</button>
                                    </td>
                                    </tr>
                                )
                            }) }
